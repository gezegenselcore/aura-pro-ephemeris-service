...
echo "   Then run:"
echo "   gsutil cp seas_433.se1 gs://aura-ephemeris/sweph/"
echo "   gsutil cp sepl_433.se1 gs://aura-ephemeris/sweph/"
...
echo ""
echo "Next steps:"
echo "1. Download ephemeris files (seas_433.se1, sepl_433.se1)"
